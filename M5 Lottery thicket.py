# -*- coding: utf-8 -*-
"""
Created on Mon Jun 29 19:05:34 2020
...
best = pd.read_csv(f"{path_results}submission_final.csv") # read your submission from Accuracy
best.head()
...
level_coef_dict = {
    ...
    ("state_id", "item_id"): get_ratios(coef=0.20),
...
df.to_csv(r"C:\Users\Radu\Desktop\ML Projects\M5 Accuracy\M5 Uncertainty\uncertainty_submission.csv", index = False)